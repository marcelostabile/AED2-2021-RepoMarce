 ...
 * @author Josse
 */
public class TriePrefixAEDIIGUI_Vector extends javax.swing.JFrame {
    
    private TArbolTrie_Vector trie;
    
    /**
     * Creates new form TriePrefixAEDIIGUI
     */
    public TriePrefixAEDIIGUI_Vector() {
        this.trie           = new TArbolTrie_Vector();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingrese la subred buscada");
        ...
        jLabel2.setText("Lista de dispositivos");
    ...
    private void jtfSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfSearchKeyReleased
        ...
        LinkedList<TDispositivo> palabras;
        //TODO: LLENAR LISTA DE PALABRAS CON EL MÉTODO PREDECIR
        palabras = this.trie.buscarDispositivos(jtfSearch.getText());
        
        for(TDispositivo palabra : palabras){
            listModel.addElement("IP: "+palabra.getDirIP()+" Dispositivo: "+palabra.getNombre());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TriePrefixAEDIIGUI_Vector.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TriePrefixAEDIIGUI_Vector().setVisible(true);
            }
        });
    }
